...
class Config(object):
    ...
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Utkarsh:9335924360@utkarsh9.af91n.mongodb.net/?retryWrites=true&w=majority&appName=Utkarsh9")
    ...
    BIN_CHANNEL = int(os.environ.get("BIN_CHANNEL", "-1002348383946"))
